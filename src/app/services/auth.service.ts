...
export class AuthService {
  ...
  register(formData: any): Observable<any> {
    ...
    return this._HttpClient.post(`http://localhost:8000/api/v1/register`, formData, this.httpOptions);
  }
  ...
  updatePassword(passwordData: any): Observable<any> {
    return this._HttpClient.patch(this.baseURL + 'user/password', passwordData, this.httpOptions);
  }
